...
namespace Telegram.API.Client.Bot.Models
{
    ...
    /// </summary>
    public class ForceReply : ITelegramType, ITelegramKeyboard
    {
        /// <summary>
        ...
        /// The last option is definitely more attractive.And if you use <see cref="ForceReply"/> in your bot's questions, 
